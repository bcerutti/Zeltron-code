...
def energy():
    ...
    data=numpy.loadtxt(".././Zeltron3D/data/Eem.dat")
    emag=data[:,0]
    eelc=data[:,1]
    ...
    # Electrons
    ekineb=numpy.loadtxt(".././Zeltron3D/data/Ekin_electrons_bg.dat")
    ekined=numpy.loadtxt(".././Zeltron3D/data/Ekin_electrons_drift.dat")

    # Ions
    ekinpb=numpy.loadtxt(".././Zeltron3D/data/Ekin_ions_bg.dat")
    ekinpd=numpy.loadtxt(".././Zeltron3D/data/Ekin_ions_drift.dat")
    ...
    # Synchrotron
    # Electrons
    esyne=numpy.loadtxt(".././Zeltron3D/data/Esyn_electrons.dat")
    # Ions
    esynp=numpy.loadtxt(".././Zeltron3D/data/Esyn_electrons.dat")

    plt.plot(esyne+esynp,ls='--',lw=2,color='magenta')

    # Inverse Compton
    # Electrons
    eicse=numpy.loadtxt(".././Zeltron3D/data/Eics_electrons.dat")
    # Ions
    eicsp=numpy.loadtxt(".././Zeltron3D/data/Eics_electrons.dat")
