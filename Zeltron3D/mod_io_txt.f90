...
IF (DUMP_FIELDS_PARALLEL.EQV..TRUE.) THEN
 ...
 CF=adjustl(CF)
  ...
  DO k=1,SIZE(F,3)
  DO j=1,SIZE(F,2)
  WRITE(9,"(" // trim(CF) // FMT_DBL // ")") (F(i,j,k),i=1,SIZE(F,1))
  ENDDO
  ENDDO
  CLOSE(9)
...
!===================================================================
  ...
  ALLOCATE(Ft(1:globalShape(1),1:globalShape(2),1:globalShape(3)))
  ...
  IF (rank == 0) THEN
    ...
    DO k=1,SIZE(Ft,3)
    DO j=1,SIZE(Ft,2)
    WRITE(9,"(" // trim(CF) // FMT_DBL // ")") (Ft(i,j,k),i=1,SIZE(Ft,1))
    ENDDO
    ENDDO
    CLOSE(9)
  ENDIF
...
DO izp=1,nz
DO iyp=1,ny
WRITE(9,"(" // trim(CX) // FMT_DBL // ")") (Bxg(ixp,iyp,izp),ixp=1,nx)
ENDDO
ENDDO
CLOSE(9)
...
DO izp=1,nz
DO iyp=1,ny
WRITE(9,"(" // trim(CX) // FMT_DBL // ")") (Byg(ixp,iyp,izp),ixp=1,nx)
ENDDO
ENDDO
CLOSE(9)
...
DO izp=1,nz
DO iyp=1,ny
WRITE(9,"(" // trim(CX) // FMT_DBL // ")") (Bzg(ixp,iyp,izp),ixp=1,nx)
ENDDO
ENDDO
CLOSE(9)
...
DO izp=1,nz
DO iyp=1,ny
WRITE(9,"(" // trim(CX) // FMT_DBL // ")") (Exg(ixp,iyp,izp),ixp=1,nx)
ENDDO
ENDDO
CLOSE(9)
...
DO izp=1,nz
DO iyp=1,ny
WRITE(9,"(" // trim(CX) // FMT_DBL // ")") (Eyg(ixp,iyp,izp),ixp=1,nx)
ENDDO
ENDDO
CLOSE(9)
...
DO izp=1,nz
DO iyp=1,ny
WRITE(9,"(" // trim(CX) // FMT_DBL // ")") (Ezg(ixp,iyp,izp),ixp=1,nx)
ENDDO
ENDDO
CLOSE(9)
...
DO izp=1,NZP
DO iyp=1,NYP
READ(10,"(" // trim(CX) // FMT_DBL // ")") (Bxg(ixp,iyp,izp),ixp=1,NXP)
ENDDO
ENDDO
CLOSE(10)
...
DO izp=1,NZP
DO iyp=1,NYP
READ(10,"(" // trim(CX) // FMT_DBL // ")") (Byg(ixp,iyp,izp),ixp=1,NXP)
ENDDO
ENDDO
CLOSE(10)
...
DO izp=1,NZP
DO iyp=1,NYP
READ(10,"(" // trim(CX) // FMT_DBL // ")") (Bzg(ixp,iyp,izp),ixp=1,NXP)
ENDDO
ENDDO
CLOSE(10)
...
DO izp=1,NZP
DO iyp=1,NYP
READ(10,"(" // trim(CX) // FMT_DBL // ")") (Exg(ixp,iyp,izp),ixp=1,NXP)
ENDDO
ENDDO
CLOSE(10)
...
DO izp=1,NZP
DO iyp=1,NYP
READ(10,"(" // trim(CX) // FMT_DBL // ")") (Eyg(ixp,iyp,izp),ixp=1,NXP)
ENDDO
ENDDO
CLOSE(10)
...
DO izp=1,NZP
DO iyp=1,NYP
READ(10,"(" // trim(CX) // FMT_DBL // ")") (Ezg(ixp,iyp,izp),ixp=1,NXP)
ENDDO
ENDDO
CLOSE(10)
...
ALLOCATE(Nid(1:NPX*NPY*NPZ),displ(1:NPX*NPY*NPZ))
